...
class BranchesDetailsTable extends Component {
	render() {
		...
		return (
			<Paper className={classes.root}>
				<Table className={classes.table}>
					<TableHead>
						<TableRow>
							<TableCell align="center">Branch Features</TableCell>
							<TableCell align="center">Branch Options</TableCell>
						</TableRow>
					</TableHead>
					<TableBody>
						{rows.map(row => {
...
BranchesDetailsTable.propTypes = {
	classes: PropTypes.object.isRequired
};

export default withStyles(styles)(BranchesDetailsTable);
